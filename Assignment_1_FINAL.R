...
# Here we can see that, depending on the metric used to calculate dissimilarity, there are different values. This may lead to a difference in interpretation in downstream analyses/conclusions.
